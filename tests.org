...
(2+x)*(x+y)
#+END_SRC
*** 00001026 Lexicographic Variables Order 7
#+BEGIN_SRC scheme :tangle tests.d/00001026-simplifyer-lex_var_7.input
(x+4)(x+3)(x+2)(x+1)
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00001026-simplifyer-lex_var_7.output
(1+x)*(2+x)*(3+x)*(4+x)
#+END_SRC
