...
Parse Error
#+END_SRC
*** 00000038 - Terminal Division
#+BEGIN_SRC scheme :tangle tests.d/00000038-parser-terminal_division.input
1+4/
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000038-parser-terminal_division.output
Parse Error
#+END_SRC
*** 00000039 - Terminal Multiplication
#+BEGIN_SRC scheme :tangle tests.d/00000039-parser-terminal_mult.input
1+x*
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000039-parser-terminal_mult.output
Parse Error
#+END_SRC
*** 00000040 - Terminal Addition
#+BEGIN_SRC scheme :tangle tests.d/00000040-parser-termnial_add.input
1+
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000040-parser-termnial_add.output
Parse Error
#+END_SRC
*** 00000041 - Terminal Subtraction
#+BEGIN_SRC scheme :tangle tests.d/00000041-parser-terminal_sub.input
1+x-
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000041-parser-terminal_sub.output
Parse Error
#+END_SRC
*** 00000042 - Subscript Addition
#+BEGIN_SRC scheme :tangle tests.d/00000042-parser-sub_adition.input
x_+
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000042-parser-sub_adition.output
x_+
#+END_SRC
*** 00000043 - Subscript Parenthesis
#+BEGIN_SRC scheme :tangle tests.d/00000043-parser-sub_paren.input
x_)
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00000043-parser-sub_paren.output
x_)
#+END_SRC
...
** Known Constants
*** 00002017 Pi
#+BEGIN_SRC scheme :tangle tests.d/00002017-parser-pi.input
\pi
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002017-parser-pi.output
\pi
#+END_SRC
*** 00002018 Phi
#+BEGIN_SRC scheme :tangle tests.d/00002018-parser-phi.input
\phi
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002018-parser-phi.output
\phi
#+END_SRC
*** 00002019 i
#+BEGIN_SRC scheme :tangle tests.d/00002019-parser-i.input
i
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002019-parser-i.output
i
#+END_SRC
** Known Functions
*** 00002020 Exp Operator
#+BEGIN_SRC scheme :tangle tests.d/00002020-parser-exp.input
\exp{3}
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002020-parser-exp.output
\exp{3}
#+END_SRC
*** 00002021 Sin
#+BEGIN_SRC scheme :tangle tests.d/00002021-parser-sin.input
\sin{3}
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002021-parser-sin.output
\sin{3}
#+END_SRC
*** 00002022 Cos
#+BEGIN_SRC scheme :tangle tests.d/00002022-parser-cos.input
\cos{3}
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002022-parser-cos.output
\cos{3}
#+END_SRC
*** 00002023 Tan
#+BEGIN_SRC scheme :tangle tests.d/00002023-parser-tan.input
\tan{3}
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002023-parser-tan.output
\tan{3}
#+END_SRC
** Ignore Spaces
*** 00002024 - Spaces in Addition
#+BEGIN_SRC scheme :tangle tests.d/00002024-parser-spaces_addition.input
1 + 2
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002024-parser-spaces_addition.output
1+2
#+END_SRC
*** 00002025 - Spaces in Multiplication
#+BEGIN_SRC scheme :tangle tests.d/00002025-parser-spaces_multiplication.input
1 * 2
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002025-parser-spaces_multiplication.output
1*2
#+END_SRC
*** 00002026 - Spaces in Implicit Multiplication
#+BEGIN_SRC scheme :tangle tests.d/00002026-parser-spaces_multiplication_implicit.input
2 x
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002026-parser-spaces_multiplication_implicit.output
2*x
#+END_SRC
*** 00002027 - Spaces Before Expression
#+BEGIN_SRC scheme :tangle tests.d/00002027-parser-spaces_before_expresion.input
 3+2
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002027-parser-spaces_before_expresion.output
3+2
#+END_SRC
*** 00002028 - Spaces Around Parenthesis
#+BEGIN_SRC scheme :tangle tests.d/00002028-parser-spaces_parentheses.input
3+ ( 2*5 ) +2
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002028-parser-spaces_parentheses.output
3+2*5+2
#+END_SRC
*** 00002029 - Spaces as Function Application
#+BEGIN_SRC scheme :tangle tests.d/00002029-parser-spaces_function.input
\ln 3
#+END_SRC
#+BEGIN_SRC scheme :tangle tests.d/00002029-parser-spaces_function.output
\ln{3}
#+END_SRC
